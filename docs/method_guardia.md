# POSEC / GUARD IA: Correção Poisson com Dose Calibrada e Gate para Previsões Neurais de Crime

*POSEC = Pareto-Optimal Spatial Error Calibration via Poisson Regression.*
*Método e protocolo experimental — documento companheiro de `posec/hybrid/{glm,guardia}.py`.*
